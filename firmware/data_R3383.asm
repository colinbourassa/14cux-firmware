...
;
;   Description: R3383 Data and build flags (94 RRC UK)
;
;       This file includes the the 2K byte data section of the R3383 ROM which
...
;----------------------------------------------------------
CRC16                   = $2CBE     ; addr FFE0/E1
TUNE_NUMBER             = $3383     ; addr FFE9/EA
CHECKSUM_FIXER          = $A9       ; addr FFEB
TUNE_IDENT              = $1A1D     ; addr FFEC/ED
...
dtc18_tpsMaximum  = $0133   ; used in ignitionInt.asm (1.5V, changed to 4V $0332 in later code)
...
LC0B5           DB          $00,$24,$38,$91,$AB,$C2,$D7,$EE ; Data table used in coolant temp routine
                DB          $26,$26,$2B,$2E,$2F,$30,$39,$4A
                DB          $00,$10,$02,$02,$02,$1B,$2F,$13
...
rsFaultSlowdownThreshold DW $0800               ; Road Speed Sensor Fault registers after this many counts
                ...
                DB          $1C,$0D,$06,$0A,$14,$1B,$1B,$1F,$26,$31,$39,$44 ; Offset = 24

                DB          $B0                 ; used in 1 Hz coundown routines
                DB          $0C                 ; maybe unused
...
accelPumpTable  DB          $00,$14,$28,$32,$3F,$52,$66,$7E,$AC,$AD,$C3,$D7 ; XC206: Used by TP routine (coolant temp, 12 values)
                DB          $0C,$0C,$0E,$12,$13,$19,$1C,$28,$28,$1E,$1E,$1E ; XC212: Offset of 12 from cooland temp table
...
LC731           DB          $18,$31,$5A,$7A,$89,$99,$B3,$CC,$DD,$EA ; (C731) used by Input Capture Interrupt (10 coolant temp values)
...
LC759           DB          $1C,$18,$10,$0C,$0B,$14,$14,$19,$19,$19
LC763           DB          $2D,$2D,$2D,$28,$24,$1E,$1E,$1E,$1E,$1E

LC76D           DB          $00,$12,$1B,$25,$47,$75,$94,$B0,$C8,$DA,$E4,$E8 ; (C76D) used by coolant temp routine
LC779           DB          $0B,$0A,$07,$0D,$1A,$1C,$31,$46,$4E,$59,$6D,$75 ; in X009B (cranking fueling value above zero F)
LC785           DB          $1C,$0D,$06,$0A,$14,$1B,$1B,$1F,$26,$31,$39,$44 ; in X009C (time fueling component, 1 Hz countdown)


LC791           DB          $00,$24,$38,$91,$AB,$C2,$D7,$EE ; (C791) used by CT routine (8 values)
LC799           DB          $26,$26,$2B,$2E,$2F,$30,$39,$4A ; offset =  8
LC7A1           DB          $00,$10,$02,$02,$02,$1B,$2F,$13 ; offset = 16
...
LC7E0           DS          $C800-*,$FF         ; Fill with $FF until start of code (which normally begins with rpmTable)
