...
;
;   Description: R3365 Data and build flags (94 D90 NAS)
;
;       This file includes the the 2K byte data section of the R3365 ROM which
...
TUNE_NUMBER             = $3365     ; addr FFE9/EA
CHECKSUM_FIXER          = $3B       ; addr FFEB
TUNE_IDENT              = $1A22     ; addr FFEC/ED
...
highRoadSpeed_ON  = $AF     ; NAS D90: 175 KPH (109 MPH)
highRoadSpeed_OFF = $F9     ; minus 7 (175 - 7 = 168 KPH)
highSpeedIndByte  = $91     ; the high road speed indicator byte (normally $AA)
...
limpHomeMap     DB          $21,$21,$21,$21,$1F,$1D,$1A,$19,$19,$19,$19,$19,$18,$14,$14,$14
                DB          $3F,$3E,$3A,$39,$39,$39,$39,$39,$3B,$3C,$3B,$39,$35,$30,$30,$30
                DB          $5D,$5C,$5B,$5B,$5C,$60,$5E,$5E,$5E,$5F,$5D,$5C,$53,$4A,$4A,$4A
...
rsFaultSlowdownThreshold DW $0800               ; Road Speed Sensor Fault registers after this many counts
                ...
                DB          $0B,$0A,$07,$0D,$1A,$27,$38,$46,$4E,$59,$6D,$75 ; Offset = 12
                DB          $1C,$0D,$06,$0A,$14,$19,$21,$26,$2C,$31,$39,$44 ; Offset = 24
                ...
                DB          $18,$21,$31,$5A,$7C,$99,$B3,$CC,$DD,$EA ; Table used in ICI
                DB          $06,$0C,$0F,$12,$16,$1C,$23,$28,$30,$30
                DB          $04,$06,$07,$08,$08,$00,$00,$00,$00,$00
                DB          $3C,$3C,$64,$8C,$B4,$FF,$FF,$FF,$FF,$FF
                DB          $28,$23,$1E,$14,$0B,$0F,$14,$19,$19,$19
                DB          $14,$14,$12,$0E,$0B,$1E,$1E,$1E,$1E,$1E
...
hotFuelThreshold      DB    $34                 ;    condenser fan timer will be set to run the fans at shutdown
                ...
                DW          $99C3               ; CE is compared with coolant temp in ICI (XC1F9 is unused)
...
accelPumpTable  DB          $00,$14,$28,$32,$3F,$52,$66,$7E,$94,$AC,$C3,$D0 ; XC206: Used by TP routine (coolant temp, 12 values)
                DB          $0C,$0C,$0E,$12,$13,$14,$19,$1C,$28,$28,$1E,$1E ; XC212: Offset of 12 from cooland temp table
...
LC731           DB          $18,$21,$31,$5A,$7C,$99,$B3,$CC,$DD,$EA ; (C731) used by Input Capture Interrupt (10 coolant temp values)
LC73B           DB          $06,$0C,$0F,$12,$16,$1C,$23,$28,$30,$30 ; index offsets are 0A, 14, 1E and ($0A + $28)
LC745           DB          $04,$06,$07,$08,$08,$00,$00,$00,$00,$00
LC74F           DB          $3C,$3C,$64,$8C,$B4,$FF,$FF,$FF,$FF,$FF
LC759           DB          $28,$23,$1E,$14,$0B,$0F,$14,$19,$19,$19
LC763           DB          $14,$14,$12,$0E,$0B,$1E,$1E,$1E,$1E,$1E

LC76D           DB          $00,$12,$1B,$25,$47,$75,$94,$B0,$C8,$DA,$E4,$E8 ; (C76D) used by coolant temp routine
LC779           DB          $0B,$0A,$07,$0D,$1A,$27,$38,$46,$4E,$59,$6D,$75 ; in X009B (cranking fueling value above zero F)
LC785           DB          $1E,$0D,$06,$0A,$14,$19,$21,$26,$2C,$31,$39,$44 ; in X009C (time fueling component, 1 Hz countdown)
...
LC7B9           DB          $B2                 ; -> X200A (used in ICI to calc FM load value row index)
                ...
                DW          $056C               ; RPM limit
LC7BD           DB          $6E                 ; -> X200E (fuel map value)
