...
;
;   Description: R3360 Data and build flags (94 RRC/Disco 3.9 NAS)
;
;       This file includes the the 2K byte data section of the R3360 ROM which
;   is from $0000 through $3FFF (mapped to $C000 through $C7FF in board). The
;   file also contains build flags which control how the code is assembled or
;   modified.
;
;------------------------------------------------------------------------------
...
;----------------------------------------------------------
CRC16                   = $F039     ; addr FFE0/E1
TUNE_NUMBER             = $3360     ; addr FFE9/EA
CHECKSUM_FIXER          = $51       ; addr FFEB
TUNE_IDENT              = $1A1F     ; addr FFEC/ED
...
rsFaultSlowdownThreshold DW $0800               ; Road Speed Sensor Fault registers after this many counts
                ...
                DB          $1C,$0D,$06,$0A,$14,$19,$25,$2B,$31,$31,$39,$44 ; Offset = 24
...
LC785           DB          $1C,$0D,$06,$0A,$14,$1E,$25,$2B,$31,$31,$39,$44 ; in X009C (time fueling component, 1 Hz countdown)
