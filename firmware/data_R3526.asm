...
;
;   Description: R3526 Data and build flags (95 RRC NAS)
;
;       This file includes the the 2K byte data section of the R3526 ROM which
...
*               = $C000
romStart        = *
limpHomeMap     DB          $20,$21,$21,$21,$1F,$1D,$1A,$19,$19,$19,$19,$19,$18,$14,$14,$14
...
rsFaultSlowdownThreshold DW $0800               ; Road Speed Sensor Fault registers after this many counts
                ...
                DB          $00,$12,$1B,$25,$47,$75,$94,$B0,$C8,$E2,$E8,$EC ; Table referenced in coolant temp routine
                DB          $0B,$0A,$07,$0D,$1A,$2A,$3C,$46,$46,$46,$50,$50 ; Offset = 12
                DB          $1C,$0D,$06,$0A,$14,$19,$25,$2B,$2B,$2B,$2D,$2D ; Offset = 24
...
LC763           DB          $2D,$2D,$2D,$28,$24,$1E,$1E,$1E,$1E,$1E
                ...
                ; this table is different for the cold weather chip
LC76D           DB          $00,$12,$1B,$25,$47,$75,$94,$B0,$C8,$DA,$E2,$E8 ; (C76D) used by coolant temp routine
LC779           DB          $0B,$0A,$07,$0D,$1A,$2A,$3C,$46,$46,$46,$46,$50 ; in X009B (cranking fueling value above zero F)
LC785           DB          $1C,$0D,$06,$0A,$14,$1E,$25,$2B,$2B,$2B,$2B,$2D ; in X009C (time fueling component, 1 Hz countdown)
